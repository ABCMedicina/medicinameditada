...
//Ruta para buscar agendas disponibles del procedimiento
...
//Ruta para crear una cita de cirugia
...
Route::get('/cita_procedimiento_editar/{cita}', [CitaController::class, 'cita_procedimiento_editar'])->name('cita.procedimiento.editar')->middleware(['auth', 'rol:medico']); 


Route::put('/cita_procedimiento_actualizar/{cita}', [CitaController::class, 'cita_procedimiento_actualizar'])->name('cita.procedimiento.actualizar')->middleware(['auth', 'rol:medico']); 


Route::put('/cita_procedimiento_cancelar/{cita}', [CitaController::class, 'cancelar_procedimiento_medico'])->name('cita.procedimiento.cancelar')->middleware(['auth', 'rol:medico']); 
...
Route::post('/email_contacto', [App\Http\Controllers\ContactoController::class, 'contacto'])->name('email.contacto');
