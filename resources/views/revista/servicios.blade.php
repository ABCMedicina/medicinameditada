...
<div class="hero h-700" style="background-image: url(/images/cirugiaplastica.jpg);">
  ...
  <div class="hero-content text-center text-neutral-content">
    <div class="max-w-md">
      ...
      <p class="mb-5" style="color:white;">Nuestros servicios incluyen dos visitas previas a la cirugía, y un período sugerido de preparación previos a la programación de un procedimiento quirúrgico, con el propósito de meditar la decisión que involucra su salud y representa un riesgo.</p>
    </div>
  </div>
</div>
...
<div class="card w-90 mx-auto mt-5 bg-primary text-primary-content" style="background-color:#e2e2e2;">
  <div class="card-body">
    ...
    <p>Con base a los resultados de la primer consulta, las dudas o temores que hayan surgido serán resueltos para la toma de decisión y programar la cirugía, informando las implicaciones del concepto "Paciente" derivado de aquellos que tienen la paciencia para enfrentar su "Aquí" y "Ahora".
</p>
    <div class="card-actions justify-end">
    </div>
  </div>
