...
<div class="hero min-h-screen bg-base-200" id="hero">
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="flex-col">
                <img id="imageplastica" src="{{ asset('storage/images/meditacion.jpg') }}" />
                <br><br>
                <img id="imageplastica" src="{{ asset('storage/images/cirugiaplastica2.jpg') }}" />
    ...
    <div>
      ...
      <!--<br>
        <p id="refplastica" style="font-size:12px;">Referencias:
        ...
        <br><br><p id="ref4" style="font-size:12px;">Referencias:
         <br>- Cetinkunar S, Ozer K, Aytac H, et al. The impact of aesthetic plastic surgery on self-esteem and self-evaluation. J Plast Reconstr Aesthet Surg. 2011;64(5):591-597. doi:10.1016/j.bjps.2010.08.024
         <br>- Sarwer DB, Crerand CE. Body image and cosmetic medical treatments. Body Image. 2004;1(1):99-111. doi:10.1016/s1740-1445(03)00004-4
         <br>- American Society of Plastic Surgeons. Plastic Surgery: An Essential Component of Health Care. Accessed March 24, 2023.
        </p>
        <br>
