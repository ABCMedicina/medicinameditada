...
<div class="hero min-h-screen bg-base-200" id="hero">
  ...
  <div class="flex-col">
                <img id="image4" src="{{ asset('storage/images/gineco4.jpg') }}" />
                <br>
                <img id="image4" src="{{ asset('storage/images/gineco3.jpg') }}" />
