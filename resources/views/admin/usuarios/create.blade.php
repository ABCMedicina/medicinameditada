                ...
                <div class="flex justify-center p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('usuarios.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="nombres" class="input block mt-1 w-full" type="text" name="nombres" :value="old('nombres')" placeholder="Ingrese nombres del usuario" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="apellidos" class="input block mt-1 w-full" type="text" name="apellidos" :value="old('apellidos')" placeholder="Ingrese apellidos del usuario" required />
                            <x-input-error :messages="$errors->get('apellidos')" class="mt-2" />
                        </div>

                        <!-- Documento -->
                        <div>
                            <x-input-label for="documento" :value="__('CURP')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="direccion" class="input block mt-1 w-full" type="text" name="direccion" :value="old('direccion')" placeholder="Ingrese dirección del usuario" required />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="input block mt-1 w-full" type="email" name="email" :value="old('email')" placeholder="correo@gmail.com" required />
