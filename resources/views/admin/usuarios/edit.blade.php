<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 mt-2 pb-2 leading-tight">
            {{ __('Editar usuario ') . $user->nombres . ' ' . $user->apellidos }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class=" mx-auto sm:px-6 lg:px-8" style="width:500px;">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('usuarios.update', $user) }}">
                        ...
                        <!-- Nombres -->
                        <div>
                            <x-input-label class="mt-2" for="nombres" :value="__('Nombres')" />
