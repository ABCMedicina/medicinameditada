        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <!--Filtros-->
                    <div id="filtros" class="flex justify-between mb-10">
                        <!--Filtrar por nombre-->
                        ...
                        <div class="flex flex-col gap-2 sm:flex-row justify-end space-x-4">
                            <p id="p">Filtrar por:</p>
                            
                            <a id="a" href="{{route('usuarios.index')}}" class="btn btn-outline btn-xs btn-success rounded-xl">Todos</a>
                            <a id="a" href="{{route('usuarios.index',['rol'=>1])}}" class="btn btn-outline btn-xs btn-success rounded-xl">Administradores</a>
                            <a id="a" href="{{route('usuarios.index',['rol'=>2])}}" class="btn btn-outline btn-xs btn-success rounded-xl">Médicos</a>
                            <a id="a" href="{{route('usuarios.index',['rol'=>3])}}" class="btn btn-outline btn-xs btn-success rounded-xl">Pacientes</a>
