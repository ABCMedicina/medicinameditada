                ...
                <form class="border-1 shadow-xl p-4" method="POST" action="{{ route('cita.procedimiento.guardar') }}">
                        ...
                        <div class="form-control">
                            <div class="input-group">
                                <input type="text" name="nombre_paciente" id="nombre_paciente" placeholder="Buscar paciente" class="input input-bordered" disabled />

                                <label for="modal_buscar_paciente" class="btn btn-square">
